...
function ssoGenerateLoginBar() {
  $r = '<div class="lo"><a href="https://id.arduino.cc//auth/login/?returnurl=http%3A%2F%2Fplayground.arduino.cc%2FComponentLib%2FThermistor2">Sign in</a> or ';
  $r += '<a href="https://id.arduino.cc/auth/register/?returnurl=http%3A%2F%2Fplayground.arduino.cc%2FComponentLib%2FThermistor2">Register</a></div>';
  document.getElementById("loginInfo").innerHTML = $r;
}
